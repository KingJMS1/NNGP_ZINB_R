...
| `print_progress` | Logical: report MCMC progress with [`message()`](https://rdrr.io/r/base/message.html) (suppress with [`suppressMessages()`](https://rdrr.io/r/base/message.html)); defaults to `FALSE`. |
