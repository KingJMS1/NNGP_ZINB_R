...
plotTemporalEffect2(
    results = results, true.b = true.b, true.d = true.d,
...
pdf(
    file = "/Users/qinghe/Documents/project/zigp/ZINB/simulation/output/y_pred_sim_dynamic.pdf", # The directory you want to save the file in
